...
#line 266 "parsedate.y"
    {
		...
		if ((yyvsp[(1) - (5)].Number) > 999) {
		    yyYear = (yyvsp[(1) - (5)].Number);
		} else {
		    yyYear = 1900 + (yyvsp[(1) - (5)].Number);
		}
		...
		if ((yyvsp[(5) - (5)].Number) > 999) {
		    /* assume year is YYYY format, so need not to add 1900 */
		    yyYear = (yyvsp[(5) - (5)].Number);
		} else if ((yyvsp[(5) - (5)].Number) < 100) {
		    /* assume year is YY format, so need to add 1900 */
		    yyYear = (yyvsp[(5) - (5)].Number) + (yyYear / 100 + (yyYear % 100 - (yyvsp[(5) - (5)].Number)) / 50) * 100;
		} else {
		    yyYear = 1900 + (yyvsp[(5) - (5)].Number);
		}
	    }
	}
    break;
...
#line 296 "parsedate.y"
    {
	    ...
	    if ((yyvsp[(4) - (4)].Number) > 999) {
		/* assume year is YYYY format, so need not to add 1900 */
		yyYear = (yyvsp[(4) - (4)].Number);
	    } else if ((yyvsp[(4) - (4)].Number) < 100) {
		/* assume year is YY format, so need to add 1900 */
		yyYear = (yyvsp[(4) - (4)].Number) + (yyYear / 100 + (yyYear % 100 - (yyvsp[(4) - (4)].Number)) / 50) * 100;
	    } else {
		yyYear = 1900 + (yyvsp[(4) - (4)].Number);
	    }
	}
    break;
...
#line 313 "parsedate.y"
    {
	    ...
	    if ((yyvsp[(3) - (3)].Number) > 999) {
		/* assume year is YYYY format, so need not to add 1900 */
		yyYear = (yyvsp[(3) - (3)].Number);
	    } else if ((yyvsp[(3) - (3)].Number) < 100) {
		/* assume year is YY format, so need to add 1900 */
		yyYear = (yyvsp[(3) - (3)].Number) + (yyYear / 100 + (yyYear % 100 - (yyvsp[(3) - (3)].Number)) / 50) * 100;
	    } else {
		yyYear = 1900 + (yyvsp[(3) - (3)].Number);
	    }
	}
    break;
